...
<LogOutIcon/>
                        ...
                        <div className="dropdown shrink-0 flex">
                            <Dropdown
                              ...
                              button ={<img src={userProfileIcon} style={{width:"35%",borderRadius:"50%"}}></img>}
                                ...
                                // button ={<IconUser/>}
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[330px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            {/* <img className="rounded-md w-10 h-10 object-cover" src="/assets/images/user-profile.jpeg" alt="userProfile" /> */}
                                            <div>
                                                    <img src={userProfileIcon} style={{width:"90%",borderRadius:"50%"}}></img>
                                                     
                                                </div>
                                            <div className="ltr:pl-1 rtl:pr-1 ">
                                                <h4 className="text-base" style={{fontSize:"16px"}}>
                                                  {userDetails?.name}

                                                </h4>
                                                <button type="button" className="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white" style={{fontSize:"13px"}}>
                                                 {userDetails?.email}
